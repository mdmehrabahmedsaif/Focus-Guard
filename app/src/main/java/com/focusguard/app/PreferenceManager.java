...
public class PreferenceManager {
    ...
    private static final String KEY_BLOCK_PARENTAL_CONTROLS = "block_parental_controls";
    ...
    public void setParentalControlsBlocked(boolean blocked) {
        prefs.edit().putBoolean(KEY_BLOCK_PARENTAL_CONTROLS, blocked).apply();
    }

    public boolean isParentalControlsBlocked() {
        return prefs.getBoolean(KEY_BLOCK_PARENTAL_CONTROLS, true);
    }
